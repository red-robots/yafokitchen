...
function my_login_logo() { 
  ...
  <style type="text/css">
    ...
    body.login .button-primary {
      background: #8bb83f;
      border-color: #7aa236 #7aa236 #7aa236;
      box-shadow: 0 1px 0 #7aa236;
      color: #fff;
      padding: 0 20px 2px!important;
      font-weight: bold;
      text-decoration: none;
      text-shadow: 0 -1px 1px #7aa236, 1px 0 1px #7aa236, 0 1px 1px #7aa236, -1px 0 1px #7aa236;
    }
    ...
    .login #login_error, .login .message, .login .success {
      border-left: 4px solid #8bb83f!important;
    }
...
function loginlogo_url_title() {
    return get_bloginfo('name');
}
add_filter( 'login_headertitle', 'loginlogo_url_title' );
